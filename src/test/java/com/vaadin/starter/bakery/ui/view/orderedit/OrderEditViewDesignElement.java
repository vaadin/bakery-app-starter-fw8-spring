...
@ServerClass("com.vaadin.starter.bakery.ui.view.orderedit.OrderEditViewDesign")
@AutoGenerated
public class OrderEditViewDesignElement extends VerticalLayoutElement {
	...
	public OrderHistoryElement getHistory() {
		return $(com.vaadin.starter.bakery.ui.view.orderedit.OrderHistoryElement.class).id("history");
	}
