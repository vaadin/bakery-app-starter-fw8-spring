...
@ServerClass("com.vaadin.starter.bakery.ui.views.orderedit.OrderEditViewDesign")
@AutoGenerated
public class OrderEditViewDesignElement extends VerticalLayoutElement {
	...
	public OrderHistoryElement getHistory() {
		return $(com.vaadin.starter.bakery.ui.views.orderedit.OrderHistoryElement.class).id("history");
	}
