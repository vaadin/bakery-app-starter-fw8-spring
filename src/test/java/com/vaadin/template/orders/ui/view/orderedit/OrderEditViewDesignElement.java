 ...
 */
@ServerClass("com.vaadin.template.orders.ui.view.orderedit.OrderEditViewDesign")
@AutoGenerated
public class OrderEditViewDesignElement extends VerticalLayoutElement {
	...
	public OrderHistoryElement getHistory() {
		return $(com.vaadin.template.orders.ui.view.orderedit.OrderHistoryElement.class).id("history");
	}
