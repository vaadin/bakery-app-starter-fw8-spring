 ...
 */
@ServerClass("com.vaadin.template.orders.ui.view.orders.ProductInfoDesign")
@AutoGenerated
public class ProductInfoDesignElement extends GridLayoutElement {
	...
	public TextFieldElement getComment() {
		return $(com.vaadin.testbench.elements.TextFieldElement.class).id("comment");
	}
}