package com.vaadin.starter.bakery.ui.eventbus;
...
public class ViewEventBusImpl implements ViewEventBus {
	...
	public void publish(Object payload) {
		...
		Consumer<?>[] listenerListCopy = listenerList.toArray(new Consumer[listenerList.size()]);
	...
	@Override
	public <T> Registration subscribe(Class<T> payloadType, Consumer<T> listener) {
		List<Consumer<?>> listenerList = listeners.computeIfAbsent(payloadType, cls -> new ArrayList<>());
