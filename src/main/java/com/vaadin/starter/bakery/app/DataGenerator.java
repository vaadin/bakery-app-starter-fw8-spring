...
public class DataGenerator implements HasLogger {
	...
	public CommandLineRunner loadData(OrderRepository orderRepository, UserRepository userRepository,
			...
			PickupLocationRepository pickupLocationRepository, PasswordEncoder passwordEncoder) {
		return args -> {
			...
			createOrders(orderRepository, customerRepository);
	...
	private void createOrders(OrderRepository orderRepo, CustomerRepository customerRepository) {
